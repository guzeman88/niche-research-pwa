...
export function readBackup(storage: Storage = localStorage): WorkspaceBackup {
...
export function previewMerge(backup: WorkspaceBackup, storage: Storage = localStorage) {
...
export function mergeBackup(backup: WorkspaceBackup, storage: Storage = localStorage) {
