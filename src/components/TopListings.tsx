    ...
    <div className="panel p-4">
      ...
      <div className="rounded-lg border border-surface-600/45 bg-surface-900/45 p-3 mb-3">
        <div className="flex items-center justify-between">
          <div>
            <div className="text-[10px] text-surface-300 uppercase font-semibold">Revenue model</div>
            <div className="text-xl font-extrabold text-surface-200 tracking-tight">TBD</div>
            <div className="text-[9px] text-surface-400">Requires observed sales and exact costs</div>
          </div>
          <div className="text-right">
            <div className="text-[10px] text-surface-300 uppercase font-semibold">Avg reviews in sample</div>
      ...
      <div className="grid grid-cols-2 gap-2 mb-2">
        <div className="bg-surface-800/30 rounded-lg p-2.5 text-center">
          ...
          <div className="text-lg font-extrabold text-surface-50">{formatPercent(starPct)}</div>
        </div>
        <div className="bg-surface-800/30 rounded-lg p-2.5 text-center">
          <div className="text-[10px] text-surface-300 uppercase font-semibold mb-0.5">Bestsellers</div>
          <div className="text-lg font-extrabold text-surface-50">{formatPercent(bestPct)}</div>
        </div>
        <div className="bg-surface-800/30 rounded-lg p-2.5 text-center">
...
function formatNumber(value: number | null): string {
  return value == null ? 'TBD' : value.toFixed(0)
}
