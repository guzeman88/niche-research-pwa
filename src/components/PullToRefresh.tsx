...
export default function PullToRefresh({ onRefresh, children, disabled }: Props) {
  ...
  return (
    <div className="relative h-full overflow-hidden">
      ...
      >
        <div className={`flex items-center gap-2 px-4 py-2 rounded-full bg-surface-800/90 backdrop-blur border border-surface-500/50 shadow-lg ${refreshing ? 'animate-pulse' : ''}`}>
